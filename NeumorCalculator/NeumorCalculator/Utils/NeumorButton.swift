...
class NeumorButton: UIButton {
    ...
    func button() {
        ...
        layer2.applySketchShadow(color: UIColor.white, alpha: 1, x: -3, y: -3, blur: 10, spread: -9)
        layer3.applySketchShadow(color: UIColor.black, alpha: 1, x: 3, y: 3, blur: 10, spread: 1)
